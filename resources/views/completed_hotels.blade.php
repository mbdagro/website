        ...
        <div class="container padding-bottom-top-120 text-uppercase text-center">
            <div class="main-title">
                ...
                <a href="{{ route('home') }}">home</a><span><i class="fa fa-angle-double-right"
                        aria-hidden="true"></i></span><a href="listing-2.html">Completed Land</a>
            </div>
        </div>
    </div>
    <!-- PAGE TITLE -->
    ...
    <section id="listings" class="padding">
        <div class="container" style="margin-top: -60px">
            <div class="row bottom40">
                {{-- <div class="col-xs-12">
                    <h2 class="uppercase">Completed Land <span class="color_red">LISTINGS</span></h2>
                    <div class="line_1"></div>
                    <div class="line_2"></div>
                    <div class="line_3"></div>
                ...
                @foreach($ProductService as $ProductService)
                    <div class="col-md-4 col-sm-6">
                        <div class="property_item bottom40">
                            <div class="image">
                                {{-- <img src="{{ asset('/') }}/{{ $ProductService->image }}" alt="listin"

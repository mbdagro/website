			...
			<div class="col-sm-16 col-md-16">
				<div class="card">
					<div class="card-footer align-items-center justify-content-between d-flex">
						<button class="btn btn-outline-success pull-right">NewsEvent List</button>
						<button class="btn btn-primary NewsEventAddButton" ><i class="fa fa-plus"></i> NewsEvent Add</button>
					</div>
					<div class="card-block">
						<div class="table-responsive" id="tab">
							<table id="news_event_table" class="table table-striped table-bordered table-hover" style="border: solid 1px rgba(255, 193, 193, 0.1);">
							</table>
...
<div class="modal dark_bg fade" id="GallaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form id="news_event_insert_update" action="{{route('news_event.update')}}" accept-charset="utf-8"  enctype="multipart/form-data" method="post"  class="form-horizontal validatable">
			<input type="hidden" name="id" value="" id="hidden-id" />
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">NewsEvent</h5>
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								<label for="example-search-input" class="col-12 col-form-label">Date</label>
								<div class="col-16">
									<input name="news_event_date" type="date" class="form-control" value="" placeholder="Enter Title">
								</div>
							</div>
						</div>
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								<label for="example-search-input" class="col-12 col-form-label"> Long Description</label>
								<div class="col-16">
									<input name="description" type="text" class="form-control" value="" placeholder="Enter Title">
								</div>
							</div>
						</div>
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								<label for="example-search-input" class="col-8 col-form-label">Image (460*400 jpg)</label>
								<div class="col-16">
						...
						<div class="col-md-16 -16  text-white">
							<div class="form-group has-success">
								...
								<label class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" name="is_pop_up" id="is_pop_up">
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description">Is pop up</span>
								</label>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		$('#news_event_table').DataTable({
            ...
            { title: 'Date', data: 'news_event_date', name: 'news_event_date' },
            { title: 'Image', data: 'image', name: 'image' },
            { title: 'Pop up', data: 'is_pop_up', name: 'is_pop_up' },

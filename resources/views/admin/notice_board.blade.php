			...
			<div class="col-sm-16 col-md-16">
				<div class="card">
					<div class="card-footer align-items-center justify-content-between d-flex">
						<button class="btn btn-outline-success pull-right">Notice Board List</button>
						<button class="btn btn-primary NewsEventAddButton" ><i class="fa fa-plus"></i> Notice Board Add</button>
					</div>
...
<div class="modal dark_bg fade" id="GallaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form id="notice_board_insert_update" action="{{route('notice_board.update')}}" accept-charset="utf-8"  enctype="multipart/form-data" method="post"  class="form-horizontal validatable">
					...
					<div class="row">
						...
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								...
								<div class="col-16">
									<input name="publish_date" type="date" class="form-control" value="" placeholder="Enter Title">
								</div>
							</div>
						</div>
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								...
								<div class="col-16">
								<input type="file" class="form-control" placeholder="" name="notice" value="">
								</div>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		$('#notice_board_table').DataTable({
            ...
            { title: 'Notice', data: 'notice', name: 'notice' },

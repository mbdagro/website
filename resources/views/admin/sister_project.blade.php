...
@section('content')
                ...
                <div class="col-sm-16 col-md-16">
                    <div class="card">
                        <div class="card-footer align-items-center justify-content-between d-flex">
                            <button class="btn btn-outline-success pull-right">Sister Project List</button>
                            <button class="btn btn-primary NewsEventAddButton"><i class="fa fa-plus"></i> Sister Project Add</button>
                        </div>
    ...
    <div class="modal dark_bg fade" id="GallaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <form id="news_event_insert_update" action="{{ route('sister_project.update') }}" accept-charset="utf-8"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Sister Project</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-16 -16  text-white">
                                <div class="form-group">
                                    <label for="example-search-input" class="col-8 col-form-label">Company</label>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.tableDelete', function() {
                ...
                $(this).ajaxSubmit({
                    ...
                    method: 'POST',
                    dataType: 'json',
                    url: "{{ route('sister_project.update') }}",

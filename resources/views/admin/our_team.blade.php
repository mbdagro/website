			...
			<div class="col-sm-16 col-md-16">
				<div class="card">
					<div class="card-footer align-items-center justify-content-between d-flex">
						<button class="btn btn-outline-success pull-right">Our Team List</button>
						<button class="btn btn-primary GallaryAddButton" ><i class="fa fa-plus"></i> Team Member Add</button>
					</div>
...
<div class="modal dark_bg fade" id="GallaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form id="gallary_insert_update" action="{{route('our_team.update')}}" accept-charset="utf-8"  enctype="multipart/form-data" method="post"  class="form-horizontal validatable">
			...
			<div class="modal-content">
				...
				<div class="modal-body">									
					<div class="row">				
						...
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								<label for="example-search-input" class="col-12 col-form-label"> Education</label>
								<div class="col-16">
									<input name="education" type="text" class="form-control" value="" placeholder="Enter Title">
								</div>
							</div>
						</div>
...
<script>
	$(document).ready(function(){
		$('#gallary_table').DataTable({
            ...
            { title: 'education', data: 'education', name: 'education' },

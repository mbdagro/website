			...
			<div class="col-sm-16 col-md-16">
				<div class="card">
					<div class="card-footer align-items-center justify-content-between d-flex">
						<button class="btn btn-outline-success pull-right">What Makes Us Best List</button>
...
<div class="modal dark_bg fade" id="GallaryAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form id="notice_board_insert_update" action="{{route('what_makes_us_best.update')}}" accept-charset="utf-8"  enctype="multipart/form-data" method="post"  class="form-horizontal validatable">
			<input type="hidden" name="id" value="" id="hidden-id" />
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">What Makes Us Best</h5>
					...
					<div class="row">
						<div class="col-md-16 -16  text-white">
							<div class="form-group">
								<label for="example-search-input" class="col-12 col-form-label"> What Makes Us Best</label>
								<div class="col-16">
									<input name="what_makes_us_best" type="text" class="form-control" value="" placeholder="What Makes Us Best">
								</div>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function(){
		$('#notice_board_table').DataTable({
			...
			serverSide: true,
			ajax: {
				url: "{{route('what_makes_us_best.data')}}",
				type: 'GET',
				cache: false
			},
			columns: [
            { title: 'SL', data: 'id', name: 'id' },
            { title: 'Title', data: 'what_makes_us_best', name: 'what_makes_us_best' },

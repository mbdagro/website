  ...
  <div class="page-title page-main-section" style="margin-top: -8px">
    <div class="container padding-bottom-top-120 text-uppercase text-center">
      <div class="main-title">
        <h1>Completed Duplex Project</h1>
        @php
          use Carbon\Carbon;
        ...
        <a href="{{ route('home') }}">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a
          href="listing-2.html">Completed Duplex Project</a>
      </div>
    </div>
  </div>
  <!-- PAGE TITLE -->
  ...
  <section id="listings" class="padding">
    <div class="container" style="margin-top: -60px">
      <div class="row bottom40">
        {{-- <div class="col-xs-12">
          <h2 class="uppercase">Completed Duplex Project <span class="color_red">LISTINGS</span></h2>
          <div class="line_1"></div>
          <div class="line_2"></div>
          <div class="line_3"></div>
...
<div class="list-head">
  <div class="container">
    <div class="section-head">
      <h4>Completed Duplex Project</h4>
      ...
      <div class="col s12 m6">
        <div class="content">
          <a href="{{ route('apartments.details',['id' => $ProductService->id]) }}">
            ...
            <img src="{{ asset('/') }}/{{$ProductService->image}}">
